...
`ifndef YSYX_22050710_MYCPU_STAGE_BUS_H
  ...
  // Bus width
  `define ysyx_22050710_FS_TO_DS_BUS_WD             160  // {fs_inst[31:0], fs_pc[63:0], fs_dnpc[63:0]} 32 + 64 + 64
  ...
  `define ysyx_22050710_BR_BUS_WD                   66   // {br_stall[0:0], br_taken[0:0], br_target[63:0]} 1 + 1 + 64
  `define ysyx_22050710_DEBUG_BUS_WD                226  // {debug_invalid, ds_inst[31:0], ds_pc[63:0], ds_dnpc[63:0], memren|memwen, memaddr[63:0]} 1 + 32 + 64 + 64 + 1 + 64
